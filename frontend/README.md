<img src="src/assets/lcc-logo.png" alt="London Chess Club logo" width="150">

---

# London Chess Club: Frontend

The Angular single-page app behind **[londonchess.ca](https://londonchess.ca)**, built with standalone components and signals, NgRx for state management, Chart.js for game and player stats, and [lichess-pgn-viewer](https://github.com/lichess-org/pgn-viewer) for replaying games.

For feature requests or to report a bug, open an [issue](https://github.com/mwiraszka/london-chess-club/issues) on GitHub, or [email](mailto:michal@londonchess.ca?subject=LCC%20Website) me directly.
